...
My research interests are primarily about Logic and its application to Formal semantics. More specifically, my primary interests are about [Description Logics](https://en.wikipedia.org/wiki/Description_logic){:target="_blank"} and [Argumentation Theory](https://en.wikipedia.org/wiki/Argumentation_theory){:target="_blank"}. 
